...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..','..','Dataset','leftImg8bit_trainvaltest')
    ...
    for f in files:
        ...
        #\r is carterage return is used to overwrite the current line
        sys.stdout.flush()
