...
# labels contain 0 -> 33 ids with -1 id so we could say in total we have 35 labels
...
if __name__ == "__main__":
    main()
    #this code takes as an input the directory of the gtfine and then it will generate the corresponding 
    #ids for the test val adn train
